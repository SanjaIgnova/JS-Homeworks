...
// Homework #3
let stringArray = ['Its', 'the', 'most','wonderful', 'time', 'of', 'the','year'];
...
function validateString(array) {
    ...
    return stryngElement;
}

console.log(validateString(stringArray));
...
let firstName = ['Sanja', 'Irena', 'Zarko','Sonja'];
let lastName = ['Ignova', ' Stojkovska', 'Ignov', 'Petrushevska'];

function fullName(array1, array2){
    let fullName = array1.length + array2.length
